...
const Deposit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://rldondon.pythonanywhere.com/deposit',
        formData,
        {
          headers: {
  ...
  return (
    ...
    <span className=' w-fit p-3 rounded-lg'>Deposit funds</span>
    </div>
    
    <form onSubmit={handleSubmit}>

            <div className='accounts_form gap-5 flex flex-col min-w-[450px] w-[100%] rounded-lg'>
